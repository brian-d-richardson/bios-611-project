...
The Tour de France is a multi-stage cycling race that has been held in France annually since 1903, with the exception several canceled tours during World War I and II. Data are available on the stages and riders in each tour from 1903 to 2021.
...
Each Tour is a multi-stage race, where riders compete in one stage per day. The number of stages per year has varied over time between 6 and 31. We can investigate this change with the following plot. In the first Tour in 1903, there were only 6 stages. This count rose on average until it peaked at 31 stages in 1937. Since in 1999, the Tour de France has had a constant 21 stages per Tour.
...
The number of riders per Tour has varied over time between 10 and 174. We can investigate this change with the following plot. In the first 2 decades, the Tour de France had fewer than 50 riders each year, with as little as 10 in 1919. Since then, the number of riders has increased on average with a maximum of 174 in 2016.
...
Each year, the different stages of the Tour uses a differnt route that takes riders across France and into neighboring countries. The start and finish of the Tour are particularly important events. The following plot demonstrates which locations are most commonly chosen as the start and finish. Although there are more than 600 distinct locations, we show only those that have hosted at least 25 starts or finishes
...
The Tour de France is scored both individually, but each rider represents a team. The following plot shows teams have had more than one Tour winner. It is important to note that many teams cycled through since 1903, and several teams have changed names during that time. For simplicity, we consider a teams with different names to be distinct.
