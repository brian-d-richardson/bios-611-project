...
team_wins %>% 
  filter(n.win > 1) %>% 
  kable(col.names = c("Team", "Number of Wins"),
        caption = "Number of Tour de France Wins by Team") %>% 
  kable_classic_2(full_width = F) -> team_wins_table
...
rider_wins %>% 
  filter(n.win > 1) %>% 
  kable(col.names = c("Rider", "Number of Wins"),
        caption = "Number of Tour de France Wins by Rider") %>% 
  kable_classic_2(full_width = F) -> rider_wins_table
